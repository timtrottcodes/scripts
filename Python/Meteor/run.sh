...
if ! pip show "$PACKAGE_NAME" &>/dev/null; then
    ...
    pip install numpy scipy scikit-image tqdm opencv-python-headless dacite onnxruntime rawpy av
    cd MetDetPy
    mkdir -p weights
    wget -O weights/yolov5s_v2.onnx https://github.com/yakhyo/yolov5-onnx-inference/releases/download/v0.0.1/yolov5x.onnx
